			...
			<div className="relative z-10 text-center px-4">
				<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
					...
					<div className="flex flex-wrap justify-center gap-4 text-sm">
						...
						<span className="px-4 py-2 bg-blue-500/10 rounded-full border border-blue-500/20">Go</span>
					...
					<div className="flex flex-wrap justify-center gap-4 text-sm mt-5">
						...
						<span className="px-4 py-2 bg-blue-500/10 rounded-full border border-blue-500/20">Codeigniter</span>
						<span className="px-4 py-2 bg-blue-500/10 rounded-full border border-blue-500/20">Node.Js</span>
						<span className="px-4 py-2 bg-blue-500/10 rounded-full border border-blue-500/20">Echo</span>
						<span className="px-4 py-2 bg-blue-500/10 rounded-full border border-blue-500/20">Bootstrap</span>
						<span className="px-4 py-2 bg-blue-500/10 rounded-full border border-blue-500/20">jQuery</span>
