				...
				>
					...
					<div className="relative z-10">
						<motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}>
							...
							<p className="text-gray-400 text-center mb-4">{t('d.contact')}</p>
						...
						<div className="flex flex-col items-center gap-6 mb-8">
							<motion.a
								href="mailto:dnxdenny@gmail.com"
							...
							>
								...
								<span className="font-medium text-gray-400">{t('b.resume')}</span>
							</motion.a>
						</div>
						<div className="flex flex-wrap justify-center gap-6">
							<motion.a
								href="https://github.com/deni-akbar"
								target="_blank"
								whileHover={{ scale: 1.05 }}
								whileTap={{ scale: 0.95 }}
							...
							<motion.a
								href="https://www.linkedin.com/in/deni-akbar-709475197/"
								target="_blank"
								whileHover={{ scale: 1.05 }}
								whileTap={{ scale: 0.95 }}
